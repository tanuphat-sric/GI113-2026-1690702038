...
namespace Lab05
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            heroHp += potionHeal;
            Console.WriteLine($"\nHero drink potion , healing {potionHeal} HP. Hero HP now {heroHp} HP");
            ...
            int roll = rng.Next(1, 101); //ต้อง+1ค่ามากสุดเสมอ เช่น 100 ต้อง 101
